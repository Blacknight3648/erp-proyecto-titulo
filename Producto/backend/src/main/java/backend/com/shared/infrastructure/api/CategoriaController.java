 ...
 *
 * <p>
 * Base URL: {@code /api/v3/maestros/categorias}
 * </p>
 *
 * <p>
 * Las categorías agrupan a los artículos en conjuntos lógicos
 * (ej: Telas, Accesorios, Prendas Listas). Cada categoría tiene un código
 * único y un nombre único en el sistema.
 * </p>
 *
 * <p>
 * Errores posibles manejados por {@code GlobalExceptionHandler}:
 * </p>
 * <ul>
 * <li>{@code 400} – Cuerpo del request inválido (validación Bean
 * Validation)</li>
...
public class CategoriaController {
     ...
     * <p>
     * <strong>Advertencia:</strong> si existen artículos o subcategorías
     * vinculadas,
