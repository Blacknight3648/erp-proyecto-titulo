 ...
 *
 * <p>Base URL: {@code /api/v3/maestros/unidades-medida}</p>
 *
 * <p>Las unidades de medida se asocian a los artículos para indicar
 * cómo se cuantifican (ej: Metro, Kilogramo, Unidad).
 * La abreviatura debe ser única en el sistema (máx. 5 caracteres).</p>
 *
...
public class UnidadMedidaController {
     ...
     */
    @PostMapping
    public ResponseEntity<UnidadMedidaResponseDTO> crear(@Valid @RequestBody UnidadMedidaRequestDTO request) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<UnidadMedidaResponseDTO> obtenerPorId(@PathVariable Integer id) {
     ...
     * <p><strong>Advertencia:</strong> si existen artículos vinculados a esta unidad,
