...
export default function ArticuloItem({
  ...
  return (
    <div className="bg-white border-2 border-gray-100 rounded-[2.5rem] p-8 space-y-8 hover:border-blue-100 transition-all group">
      
      {/* HEADER */}
      <div className="flex justify-between items-center border-b border-gray-50 pb-6">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 bg-gray-900 text-white rounded-2xl flex items-center justify-center font-black text-sm">
            {index + 1}
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full bg-gray-50 p-4 rounded-2xl text-sm font-bold text-gray-700 outline-none border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all"
          />
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className={`text-[11px] font-black uppercase tracking-widest ${
                  articulo.tipoTalla === opt.id ? "text-blue-700" : "text-gray-600"
                }`}>
                  {opt.label}
                </span>
                {articulo.tipoTalla === opt.id && (
      ...
      {articulo.tipoTalla ? (
        <div className="bg-gray-50/50 p-8 rounded-[2rem] border-2 border-dashed border-gray-100">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex justify-between items-center">
            <div>
              <h5 className="text-[10px] font-black text-gray-800 uppercase tracking-widest">Resumen de Carga</h5>
              <p className="text-[9px] font-bold text-gray-400 uppercase">Cantidad calculada automáticamente</p>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Cant. Total:</span>
              <div className="bg-gray-900 text-white px-6 py-3 rounded-2xl font-black text-xl shadow-xl shadow-gray-200 min-w-[80px] text-center">
        ...
        <div className="py-12 text-center rounded-[2rem] border-2 border-dashed border-gray-100 bg-gray-50/30">
