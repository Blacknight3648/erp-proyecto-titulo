 ...
 *
 * <p>Base URL: {@code /api/v3/maestros/familias-tela}</p>
 *
 * <p>Una familia de tela agrupa tipos de tela por su origen o proceso de fabricación
 * (ej: Tejido Plano, Tejido Punto, No Tejido). El código de familia debe ser único.</p>
 *
...
public class FamiliaTelaController {
     ...
     */
    @PostMapping
    public ResponseEntity<FamiliaTelaResponseDTO> crear(@Valid @RequestBody FamiliaTelaRequestDTO request) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<FamiliaTelaResponseDTO> actualizar(
            @PathVariable Integer id,
            @Valid @RequestBody FamiliaTelaRequestDTO request) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<FamiliaTelaResponseDTO> obtenerPorId(@PathVariable Integer id) {
     ...
     */
    @GetMapping
    public ResponseEntity<List<FamiliaTelaResponseDTO>> listarTodas() {
