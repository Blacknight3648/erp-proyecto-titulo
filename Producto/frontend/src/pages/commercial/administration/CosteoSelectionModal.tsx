        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm">
            <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 flex flex-col animate-in fade-in zoom-in duration-300">
                <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                    <div>
                        <h3 className="text-xl font-black text-gray-900 tracking-tight">Vincular Costeo</h3>
                ...
                <div className="px-8 pt-6">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold outline-none focus:ring-2 focus:ring-indigo-200 transition-all"
                        />
                    </div>
                </div>
                ...
                <div className="p-8 pt-4 space-y-3 max-h-[55vh] overflow-y-auto">
                    {loading ? (
                        <p className="text-sm text-gray-400 font-bold text-center py-8">Cargando costeos…</p>
                    ) : filtered.length === 0 ? (
                            ...
                            {filtered.map((c) => (
                                ...
                                >
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-black text-gray-900">{c.numeroCosteo || `Costeo #${c.idCosteo}`}</p>
