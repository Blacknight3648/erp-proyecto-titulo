...
public class SCOSPlantilla {
    ...
    public SCOSPlantilla(Long id, String nombre, String descripcion, String nombrePrenda, String genero,
            Map<String, Object> detallesPrenda, Map<String, String> camposPersonalizados,
            List<String> camposActivos,
            List<PlantillaTela> plantillaTelas, List<PlantillaAccesorio> plantillaAccesorios,
            List<SCOSLogotipo> plantillaLogotipos, List<SCOSPlantillaMaterialVinculo> vinculos,
            java.math.BigDecimal moPrenda, java.math.BigDecimal moCosturaSellada,
            java.math.BigDecimal moAcolchado) {
        this.id = id;
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.nombrePrenda = nombrePrenda;
        this.genero = genero;
        this.detallesPrenda = detallesPrenda != null ? detallesPrenda : new HashMap<>();
        this.camposPersonalizados = camposPersonalizados != null ? camposPersonalizados : new HashMap<>();
