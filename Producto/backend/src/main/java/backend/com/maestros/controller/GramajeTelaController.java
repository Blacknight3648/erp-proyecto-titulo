 ...
 *
 * <p>Base URL: {@code /api/v3/maestros/gramajes-tela}</p>
 *
 * <p>El gramaje indica el peso de la tela en gramos por metro cuadrado (gr/m²),
 * que es un factor clave para determinar su uso en vestuario.
 * Cada gramaje pertenece a una categoría de vestuario (ej: Camisería, Abrigo).</p>
 *
 ...
 */
@RestController
@RequestMapping("/api/v3/maestros/gramajes-tela")
...
public class GramajeTelaController {
     ...
     */
    @PostMapping
    public ResponseEntity<GramajeTelaResponseDTO> crear(@Valid @RequestBody GramajeTelaRequestDTO request) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<GramajeTelaResponseDTO> actualizar(
            @PathVariable Integer id,
            @Valid @RequestBody GramajeTelaRequestDTO request) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<GramajeTelaResponseDTO> obtenerPorId(@PathVariable Integer id) {
     ...
     */
    @GetMapping
    public ResponseEntity<List<GramajeTelaResponseDTO>> listarTodos() {
    ...
    public ResponseEntity<List<GramajeTelaResponseDTO>> listarPorCategoria(
