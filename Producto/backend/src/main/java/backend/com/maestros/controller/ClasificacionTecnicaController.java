...
/**
 * Controlador REST para la gestión del catálogo de Clasificaciones Técnicas de tela.
 *
 * <p>Base URL: {@code /api/v3/maestros/clasificaciones-tecnicas}</p>
 *
 * <p>Una clasificación técnica describe la categoría funcional de una tela
 * (ej: Tela Funcional, Tela Técnica, Tela Deportiva).
 * El nombre de clasificación debe ser único en el sistema.</p>
 *
...
public class ClasificacionTecnicaController {
     ...
     */
    @PostMapping
    public ResponseEntity<ClasificacionTecnicaResponseDTO> crear(
            @Valid @RequestBody ClasificacionTecnicaRequestDTO request) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<ClasificacionTecnicaResponseDTO> actualizar(
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ClasificacionTecnicaResponseDTO> obtenerPorId(@PathVariable Integer id) {
     ...
     */
    @GetMapping
    public ResponseEntity<List<ClasificacionTecnicaResponseDTO>> listarTodas() {
