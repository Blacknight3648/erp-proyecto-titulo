            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center bg-gray-50 rounded-xl p-1 border border-gray-100">
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-white hover:text-rose-500 transition-all"
                >
                  <Minus size={14} />
                </button>
                <input
                ...
                <button
                  type="button"
                  onClick={() => updateQuantity(idx, 1)}
                  className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-white hover:text-blue-600 transition-all"
                >
                  <Plus size={14} />
                </button>
              </div>
