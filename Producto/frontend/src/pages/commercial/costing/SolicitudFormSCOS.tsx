...
import InformacionSolicitudPanel from "./InformacionSolicitudPanel";
import FichaPrendaPanel from "./FichaPrendaPanel";
...
export default function SolicitudFormSCOS({
    ...
    return (
        <div className="w-full max-w-[1600px] mx-auto px-4 xl:px-10 py-6 space-y-8 text-foreground antialiased font-sans animate-in fade-in duration-500">
            <SolicitudHeader
                formData={formData}
                onBack={onBack}
                onSave={onSave}
