 ...
 *
 * <p>
 * Base URL: {@code /api/v3/maestros/subcategorias}
 * </p>
 *
 * <p>
 * Una SubCategoría pertenece siempre a una {@code Categoria} padre
 * (ej: Categoría "Telas" → SubCategoría "Tela Plana", "Tela Punto").
 * El request debe incluir el {@code idCategoria} del padre.
 * </p>
 *
 * <p>
 * Errores posibles:
...
public class SubCategoriaController {
     ...
     */
    @PostMapping
    public ResponseEntity<SubCategoriaDTO> crear(@Valid @RequestBody SubCategoriaDTO request) {
    ...
    public ResponseEntity<SubCategoriaDTO> actualizar(
            ...
            @Valid @RequestBody SubCategoriaDTO request) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<SubCategoriaDTO> obtenerPorId(@PathVariable Integer id) {
    ...
    /**
     * Lista todas las subcategorías que pertenecen a una categoría padre
     * específica.
    ...
    public ResponseEntity<List<SubCategoriaDTO>> listarPorCategoria(
