        ...
        <div className="space-y-8 animate-in slide-in-from-right-8 duration-500 pb-32">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h2 className="text-3xl font-black text-slate-800 tracking-tight uppercase">Nueva Orden de Servicio</h2>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Proceso externo subcontratado</p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest">Datos del Servicio</h3>
                        </div>
                ...
                <div className="space-y-6">
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 space-y-6 text-white">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-3xl font-black tracking-tighter tabular-nums text-emerald-400">{formatCLP(totalEstimado)}</p>
                        </div>
