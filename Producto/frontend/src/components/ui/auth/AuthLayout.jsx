...
export default function AuthLayout({ children }) {
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0f1d] relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-500/15 blur-[120px] rounded-full animate-pulse"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-500/15 blur-[120px] rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-8 sm:p-12 rounded-[2.5rem] shadow-2xl w-full max-w-md z-10 mx-4 relative">
                ...
                <div className="text-center mb-10 relative z-10">
                    <div className="bg-gradient-to-br from-blue-500 to-purple-500 w-20 h-20 rounded-[1.5rem] flex items-center justify-center mx-auto mb-6 shadow-[0_0_40px_-10px_rgba(92,142,242,0.5)] border border-blue-400/20">
